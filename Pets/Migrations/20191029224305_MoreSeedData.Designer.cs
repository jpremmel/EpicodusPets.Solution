...
namespace Pets.Migrations
{
    ...
    [Migration("20191029224305_MoreSeedData")]
            ...
            modelBuilder.Entity("EpicodusPets.Models.Pet", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Very sassy when restless but irresistably cute when sleepy",
                            FavoriteThings = "Paper bags, boxes, being gently stroked on the nose while falling asleep",
                            Gender = "Male",
                            LeastFavoriteThings = "Sylvie",
                            Name = "Jasper",
                            Owner = "Will (Jacqueline's roommate)",
                            PhotoPath = "wwwroot/uploads/jasper-jacqueline.jpg",
                            Species = "Cat"
                        },
                        new
                        {
                            ...
                            Age = 5,
                            Breed = "Dachshund mix",
                            Description = "#1 Handsy Boy",
                            FavoriteThings = "Wearing clothes and playing with the hose",
                            Gender = "Male",
                            LeastFavoriteThings = "strangers, other dogs playing with his toys",
                            Name = "Levi",
                            Owner = "Joey (Jason's brother)",
                            PhotoPath = "wwwroot/uploads/levi-jason.jpg",
                            Species = "Dog"
                        });
                });
